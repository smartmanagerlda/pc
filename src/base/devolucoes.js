...
function estrategias(){
    ...
    .then(data => {
        ...
        console.log(data[0]['devolucoes']);
        let listEstrategias = data[0]['devolucoes'];
        for (var i = 0; i < listEstrategias.length; i++){
            let idd = data[0]['devolucoes'][i]['_id'];
            output += `
        ...
        <div class="card text-center">
          <div class="card-body text-black">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-black text-uppercase mb-1" id=${'titulo'+idd}>${data[0]['devolucoes'][i]['titulo']}</div>
                  <div class="h5 mb-0 font-weight-bold text-black"><h6 id=${'corpo'+idd}>${data[0]['devolucoes'][i]['corpo']}</h6></div>
    ...
    editPostForm.addEventListener('submit', (e) => {
        ...
        e.preventDefault();
        const urlLogIn3 = 'https://stocksmanager1.herokuapp.com/devolucoes/corpo';
        let pora2 = new Request(urlLogIn3, {
        method: 'PATCH',
        headers: h,
        body: JSON.stringify({
        ...
        const urlLogIn = 'https://stocksmanager1.herokuapp.com/devolucoes/titulo';
...
addPostForm.addEventListener('submit', (e) => {
    if (bodyValue.value) {
        e.preventDefault();
        const urlLogIn3 = 'https://stocksmanager1.herokuapp.com/devolucoes';
        let pora2 = new Request(urlLogIn3, {
        method: 'PATCH',
        headers: h,
        body: JSON.stringify({
