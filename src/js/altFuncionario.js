...
fetch(url3)
        ...
        .then(content => {           
            ...
            for (var i = 0; i < data.length; i++){
                const ress = content[0]['funcionarios'][i]['altFuncio'];
                console.log(content[0]['funcionarios'][i]['altFuncio'][0]);
                ...
                newCell2.innerHTML = `<div class="nomeColabora" id=${ress[i]._id}>${ress[i].nomeColabora}</div>`;
                newCell3.innerHTML = `<div class="cargo" id=${ress[i]._id}>${ress[i].cargo}</div>`;
                newCell4.innerHTML = `<div class="de" id=${ress[i]._id}>${ress[i].de}</div>`;
                newCell5.innerHTML = `<div class="ate" id=${ress[i]._id}>${ress[i].ate}</div>`;
                newCell6.innerHTML = `<div class="jornada" id=${ress[i]._id}>${ress[i].jornada}</div>`;
                newCell7.innerHTML = `<div class="escolaridade" id=${ress[i]._id}>${ress[i].escolaridade}</div>`;
            }
